...
弘毅インターナショナル`,image:`./src/assets/CompanyPhilosophy.svg`,logo:`./src/assets/logo.svg`},t={title:`会社理念`,paragraphs:[`広い器量と強い意志を持って、`,`国際ビジネスの発展に貢献します。`,``,`私たちは、革新的なソフトウェア開発と`,`グローバルな視点での事業展開を通じて、`,`お客様の成功と社会の発展に寄与します。`,``,`「信頼は人から」をモットーに、`,`お客様満足度No.1企業を目指します。`,``,`世の為、人の為、`,`幸せなれるように努めます。`],image:`./src/assets/CompanyPhilosophy.svg`},n=[{title:`システム開発事業`,description:`ソフトウェア開発、システム設計・開発・運用、SESサービス。クライアント様のニーズに見合うシステム設計・開発・運用等業務を行います。`,image:`./src/assets/SystemDevelopmentBusiness.jpg`},{title:`国際貿易`,description:`日中を中心とした国際貿易業務。国境線のないビジネスの展開で、日中の架橋になれるように力を注ぎます。`,image:`./src/assets/ChinaJapanTrade.jpg`,reverse:!0},{title:`金融事業`,description:`金融サービス、投資関連事業。様々な課題や将来起こる問題に合わせたソリューションをご提案いたします。`,image:`./src/assets/FinancialBusiness.jpg`},{title:`リサイクル事業`,description:`希少金属資源のリサイクル、環境事業。情報セキュリティを確保された状態を保ち、安心して利用できる環境を提供しています。`,image:`./src/assets/RecyclingBusiness.jpg`,reverse:!0}],r=[{name:`HOME`,href:`#hero`},{name:`システム開発事業`,href:`#works`},{name:`国際貿易`,href:`#works`},{name:`金融事業`,href:`#works`},{name:`リサイクル事業`,href:`#works`},{name:`求人情報`,href:`#recruitment`},{name:`お問い合わせ`,href:`#contact`}],i=document.querySelector(`#app`);i.innerHTML=`
