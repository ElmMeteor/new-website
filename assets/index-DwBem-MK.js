...
弘毅インターナショナル`,image:`${e}assets/CompanyPhilosophy.svg`,logo:`${e}assets/logo.svg`},n={title:`会社理念`,paragraphs:[`広い器量と強い意志を持って、`,`国際ビジネスの発展に貢献します。`,``,`私たちは、革新的なソフトウェア開発と`,`グローバルな視点での事業展開を通じて`,`お客様の成功と社会の発展に寄与します。`,``,`「信頼は人から」をモットーに`,`お客様満足度No.1企業を目指します。`,``,`世の為、人の為`,`幸せなれるように努めます。`],image:`${e}assets/CompanyPhilosophy.svg`},r=[{title:`システム開発事業`,description:`ソフトウェア開発、システム設計・開発・運用、SESサービス。クライアント様のニーズに見合うシステム設計・開発・運用等業務を行います。`,image:`${e}assets/SystemDevelopmentBusiness.jpg`},{title:`国際貿易`,description:`日中を中心とした国際貿易業務。国境線のないビジネスの展開で、日中の架橋になれるように力を注ぎます。`,image:`${e}assets/ChinaJapanTrade.jpg`,reverse:!0},{title:`金融事業`,description:`金融サービス、投資関連事業。様々な課題や将来起こる問題に合わせたソリューションをご提案いたします。`,image:`${e}assets/FinancialBusiness.jpg`},{title:`リサイクル事業`,description:`希少金属資源のリサイクル、環境事業。情報セキュリティを確保された状態を保ち、安心して利用できる環境を提供しています。`,image:`${e}assets/RecyclingBusiness.jpg`,reverse:!0}],i=[{name:`HOME`,href:`#hero`},{name:`システム開発事業`,href:`#works`},{name:`国際貿易`,href:`#works`},{name:`金融事業`,href:`#works`},{name:`リサイクル事業`,href:`#works`},{name:`求人情報`,href:`#recruitment`},{name:`お問い合わせ`,href:`#contact`}],a=document.querySelector(`#app`);a.innerHTML=`
...
`;var o=document.getElementById(`header`),s=document.querySelector(`.hero-text`),c=document.querySelector(`.hero-bg`),l=document.querySelectorAll(`.work-img`),u=document.querySelectorAll(`.fade-up, .work-item`);window.addEventListener(`scroll`,()=>{let e=window.scrollY,t=window.innerHeight;e>50?(o.classList.add(`bg-black`,`shadow-lg`),o.classList.remove(`bg-black/80`)):(o.classList.remove(`bg-black`,`shadow-lg`),o.classList.add(`bg-black/80`)),s&&c&&(s.style.transform=`translateY(${e*.3}px)`,c.style.transform=`translateY(${e*.1}px) scale(1.05)`),l.forEach(t=>{let n=t.getBoundingClientRect().top+e;t.style.transform=`translateY(${(e-n)*.2}px)`}),u.forEach(e=>{e.getBoundingClientRect().top<t*.85&&(e.classList.remove(`opacity-0`,`translate-y-10`),e.classList.add(`opacity-100`,`translate-y-0`))}),s&&s.getBoundingClientRect().top<t*.85&&(s.classList.remove(`opacity-0`,`translate-y-10`),s.classList.add(`opacity-100`,`translate-y-0`))}),window.dispatchEvent(new Event(`scroll`));